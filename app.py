...
=======
# Numeric columns
>>>>>>> 2c63498d833ac9e4dfdf6d85afd502200b9ea326
num_cols = [
...
fig1 = px.bar(
    ...
    y='Happiness Score',
    color='Region',
    title='Top 10 Happiest Countries (2016)',
    text_auto=True
)
...
# Pie Chart - Average Happiness by Region
=======
    size='Health (Life Expectancy)',
    size_max=15,
...
<<<<<<< HEAD
    title='Global Map: GDP per Capita and Life Expectancy (2016)',
=======
